        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title col s5"><b>{{__('messages.service_page.add service')}}</b></h5>
            ...
            <div class="row">
                <div class="col s12 m8  offset-m2">
                    <div class="card-panel">
                        <div class="row">
                            <form id="service_form" method="post" action="{{route('services.store')}}">
                                {{@csrf_field()}}
                                <div class="row">
                                    ...
                                    <div class="row form_align">
                                        <div class="input-field col s6">
                                            ...
                                            <input id="letter" name="letter" type="text" value="{{old('letter')}}" data-error=".letter">
                                            <div class="letter">
                                        ...
                                        <div class="input-field col s6">
                                            ...
                                            <input id="start_number" name="start_number" type="number" value="{{old('start_number')}}" data-error=".start_number">
                                    ...
                                    <div id="sms_tab">
                                        <div class="row form_align">
                                            <h3 style="margin-left: 16px; margin-right:16px">{{__('messages.settings.SMS Settings')}}</h3>
                                        </div>
                                        <div class="row form_align">
                                            <div class="input-field col s6">
                                        ...
                                        <div class="row form_align">
                                            <div class="input-field col s6" style="margin-top: 0;" id="noshow_message_tab">
                                                ...
                                                <label for="noshow_message_format">{{__('messages.service_page.No Show Message Format')}}</label>
                                            ...
                                            <div class="input-field col s6" style="margin-top: 0;float: right;" id="completed_message_tab">
                                                ...
                                                <label for="completed_message_format">{{__('messages.service_page.Service Completed Message Format')}}</label>
