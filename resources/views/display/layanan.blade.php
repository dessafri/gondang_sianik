                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div v-for="(token, index) in tokens" :key="index">
                                                    <div v-if="token.service.name === '{{ $serviceName }}'">
                                                        <span class="bolder-color" style="font-size:45px;font-weight:bold;line-height:1.2">@{{ token.token_letter }}-@{{ token.token_number }}</span><br>
                                                        <small class="bolder-color" :id="'counter' + index" style="font-size:25px;font-weight:bold;">@{{ token.counter.name }}</small><br>
